...
# saving as data frames
occ_extract_final <- as.data.frame(occ_extract)
bg_extract_final <- as.data.frame(bg_extract)

# adding lat/long back in
occ_extract_final$latitude <- occs.xy$latitude
occ_extract_final$longitude <- occs.xy$longitude

bg_extract_final$latitude <- bg.xy$y
bg_extract_final$longitude <- bg.xy$x
...
- does it need the long/lat again?
...
# adding lat/long back in
occ_extract_future_final$latitude <- occs.xy$latitude
occ_extract_future_final$longitude <- occs.xy$longitude
