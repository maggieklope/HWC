...
bgExt <- circles(occs, d = 50000, lonlat = TRUE)
...
#write.csv(lion_SWD, "maxent_SWD/lion_SWD.csv", row.names = F)
#write.csv(bg_SWD, "maxent_SWD/bg_SWD.csv", row.names = F)
...
# save csv
write.csv(occ_future_extract, "maxent_SWD/lion_future_SWD.csv", row.names = F)# extracting values
...
# save csv
write_csv(occ_extract_future_final, "maxent_SWD/lion_future_SWD.csv")
```
